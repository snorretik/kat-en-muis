...
muisImgR = pygame.image.load(path.join(working_dir, 'Muis-met-rand-rechts.png'))
muisImgL = pygame.image.load(path.join(working_dir, 'Muis-met-rand-links.png'))
katImg = pygame.image.load(path.join(working_dir, 'Kat-met-rand.png'))
muisx = 10
muisy = 10
muisRicht = 'rechts'
